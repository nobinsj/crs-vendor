  ...
  return (
    <div className="relative w-full">
      <input
        ...
        data-slot="input"
        className={cn(
          "h-10 w-full rounded-lg border px-3 py-2 text-base transition-colors outline-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
          "border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:border-blue-500",
          "dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-400 dark:focus:border-blue-400",
          className
        )}
        {...props}
      />
